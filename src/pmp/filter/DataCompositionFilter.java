...
public abstract class DataCompositionFilter<in, out>  extends AbstractFilter<in, out> implements Runnable {
     ...
     */
    public out read() throws StreamCorruptedException, FileNotFoundException {
     ...
     * @throws StreamCorruptedException
     */
    protected out getNextEntity() throws StreamCorruptedException, FileNotFoundException {
        if (!m_EndOfStream) {
